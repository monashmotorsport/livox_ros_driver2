...
struct SchemaValidationContext {
    ...
    SchemaValidationContext(SchemaValidatorFactoryType &f, ErrorHandlerType &eh, const SchemaType *s)
        : factory(f), error_handler(eh), schema(s), valueSchema(), invalidKeyword(), hasher(), arrayElementHashCodes(),
          validators(), validatorCount(), patternPropertiesValidators(), patternPropertiesValidatorCount(),
...
public:
    ...
    bool EndObject(Context &context, SizeType memberCount) const
    {
        if (hasRequired_)
        {
            ...
            if (context.error_handler.EndMissingProperties()) RAPIDJSON_INVALID_KEYWORD_RETURN(GetRequiredString());
        }
        ...
        if (hasDependencies_)
        {
            ...
            if (context.error_handler.EndDependencyErrors()) RAPIDJSON_INVALID_KEYWORD_RETURN(GetDependenciesString());
        }
